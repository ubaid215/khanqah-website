                ...
                <div className="flex flex-wrap items-center gap-2 mb-3 sm:mb-4">
                  {course.categories &&
                    course.categories.map((cat) => (
                      <span
                        key={cat.category.id}
                        className="px-2 sm:px-3 py-1 bg-white/20 backdrop-blur-sm text-white text-xs sm:text-sm font-semibold rounded-full"
                      >
                        {cat.category.name}
                      </span>
                    ))}
                ...
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-white/90 text-xs sm:text-sm mb-4 sm:mb-6">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-bold text-white">
                      {course.avgRating?.toFixed(1) || "4.8"}
                    </span>
              ...
              >
                <div className="relative h-48">
                  <img
                    src={
                      course.thumbnail ||
                      "https://images.unsplash.com/photo-1609599006353-e629aaabfeae?w=1200&h=600&fit=crop"
                    }
                    alt={course.title}
              ...
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                {activeTab === "overview" && (
                  ...
                  >
                    ...
                    (typeof course.objectives === "boolean" &&
                      course.objectives) ? (
                      <>
                    ...
                    (typeof course.requirements === "boolean" &&
                      course.requirements) ? (
                      <>
                        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">
                          Requirements
                ...
                {activeTab === "curriculum" && (
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base text-gray-600 mb-6">
                      ...
                      lessons • {calculateTotalDuration()} total
                    </p>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
                        ...
                        <span className="font-semibold">
                          {related.avgRating?.toFixed(1) || "4.5"}
                        </span>
